...
#define kModifyGroupNameURL @"/v2/group"
...
//    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@/%@",self.restSeverHost,subString,[EMClient sharedClient].currentUsername]];
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@/%@",self.restSeverHost,subString,username]];
                        ...
                        completion:(void (^)(NSInteger statusCode, NSString *response))aCompletionBlock
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@/%@/updateGroup",self.restSeverHost,kModifyGroupNameURL,groupId]];
