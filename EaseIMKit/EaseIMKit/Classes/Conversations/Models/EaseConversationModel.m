...
- (NSAttributedString *)showInfo {
    ...
    if ([_conversation draft] && ![[_conversation draft] isEqualToString:@""]) {
        ...
        [_showInfo addAttributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:255/255.0 green:43/255.0 blue:43/255.0 alpha:1.0]} range:NSMakeRange(0, _showInfo.length)];
    }
