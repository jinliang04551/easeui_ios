...
@interface EaseWebViewController ()
...
- (WKWebView *)webView {
    if (!_webView) {
        ...
        _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, 0, EaseIMKit_ScreenWidth, EaseIMKit_ScreenHeight) configuration:config];
