...
{
    EaseIMKitOptions *retModel = [[[self class] alloc] init];
...
+ (instancetype)sharedOptions
{
    ...
    dispatch_once(&onceToken, ^{
        sharedOptions = EaseIMKitOptions.customOptions;
        if (!sharedOptions) {
            sharedOptions = EaseIMKitOptions.defaultOptions;
...
+ (instancetype)defaultOptions {
    return [[EaseIMKitOptions alloc] init];
}
