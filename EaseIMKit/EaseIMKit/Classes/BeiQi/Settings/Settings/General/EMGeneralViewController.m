...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    EMDemoOptions *options = [EMDemoOptions 
                              sharedOptions];
    ...
    if (section == 0) {
        ...
        if (row == 0) {
            ...
            cell.switchActionBlock = ^(BOOL isOn) {
                ...
                [EMClient sharedClient].options.autoAcceptGroupInvitation = isOn;
            ...
            [cell.aSwitch setOn:[EMClient sharedClient].options.deleteMessagesOnLeaveGroup animated:NO];
            EM_WS
            cell.switchActionBlock = ^(BOOL isOn) {
                [[EMClient sharedClient].options setDeleteMessagesOnLeaveGroup:isOn];
                [weakSelf.tableView reloadData];
            };
