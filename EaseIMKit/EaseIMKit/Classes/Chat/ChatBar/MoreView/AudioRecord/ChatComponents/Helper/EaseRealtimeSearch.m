...
static EaseRealtimeSearch *defaultUtil = nil;

@interface EaseRealtimeSearch()
...
@implementation EaseRealtimeSearch
...
+ (instancetype)shared
{
    ...
    dispatch_once(&onceToken, ^{
        defaultUtil = [[EaseRealtimeSearch alloc] init];
    });
