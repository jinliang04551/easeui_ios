...
@protocol EaseSearchControllerDelegate;
@interface EaseSearchResultController : EaseRefreshViewController

@property (nonatomic, weak) id<EaseSearchControllerDelegate> delegate;
...
@protocol EaseSearchControllerDelegate <NSObject>
