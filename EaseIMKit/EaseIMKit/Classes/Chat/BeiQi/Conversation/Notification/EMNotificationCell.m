...
- (void)_setupSubviews
{
    self.backgroundColor = EaseIMKit_Color_LightGray;
    self.contentView.backgroundColor = EaseIMKit_Color_LightGray;
    ...
    self.avatarView = [[UIImageView alloc] initWithImage:[UIImage easeUIImageNamed:@"defaultAvatar"]];
    ...
    line1.backgroundColor = EaseIMKit_Color_Gray;
...
- (UIButton *)agreeButton
{
    if (_agreeButton == nil) {
        ...
        [_agreeButton setTitleColor:EaseIMKit_Color_Blue forState:UIControlStateNormal];
        ...
        line.backgroundColor = EaseIMKit_Color_Gray;
