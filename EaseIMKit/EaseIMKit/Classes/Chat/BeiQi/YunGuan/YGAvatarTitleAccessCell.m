...
- (void)updateWithObj:(id)obj {
    ...
    YGSearchGroupModel *group = (YGSearchGroupModel *)obj;
    self.isGroupMember = group.isJoined;
    
    self.groupId = group.groupId;
    self.nameLabel.text = group.groupName;
    self.iconImageView.image = [UIImage easeUIImageNamed:@"jh_group_icon"];
...
- (UILabel *)detailLabel {
    if (_detailLabel == nil) {
        ...
        _detailLabel.font = EaseIMKit_NFont(12.0);
